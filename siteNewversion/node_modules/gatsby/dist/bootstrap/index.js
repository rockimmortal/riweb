...
const reporter = require(`gatsby-cli/lib/reporter`); // Show stack trace on unhandled promises.
...
module.exports = async args => {
  ...
  activity.end(); // if (process.env.GATSBY_DB_NODES === `loki`) {
  ...
  const graphqlRunner = (0, _createGraphqlRunner.createGraphQLRunner)(store, report); // Collect pages.
